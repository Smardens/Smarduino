...
void handle_feed() {
  ...
  storePostVals(id, temp, hum, uv, sm); //inital serial.println
}
...
void storePostVals(String _id, String _temp, String _hum, String _uv, String _sm) {
  Serial.println("Values received from Post: ");
  WiFi.disconnect();  
  String data = "id=";
  data += String(_id);
  data += "&temp=";
